...
public class ShopKeeperCategory extends BlankRecipeCategory<ShopKeeperWrapper> {

	public static final String CATEGORY = "shopkeeper";
    ...
    public ShopKeeperCategory() {
    	super(CATEGORY, 
    			PixelmonJei.getGuiHelper().createDrawable(TEXTURE_LOCOCATION_ICON, 32, 0, 16, 16),
    			PixelmonJei.getGuiHelper().createDrawable(TEXTURE_LOCOCATION_GUI, 0, 0, 169, 120));
    }
	...
	@Override
	public void setRecipe(IRecipeLayout recipeLayout, ShopKeeperWrapper recipeWrapper, IIngredients ingredients) {
