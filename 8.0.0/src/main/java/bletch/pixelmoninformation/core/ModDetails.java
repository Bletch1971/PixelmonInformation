...
public class ModDetails {
	...
	private static final int VersionRevision = 7;
	...
	public static final String MOD_DEPENDENCIES = "required-after:minecraft@[1.12.2];required-after:forge@[14.23.5.2854,);required-after:pixelmon@[8.0.0,);after:jei;after:waila;after:theoneprobe;after:jeresources";

	public static final String MOD_UPDATE_URL="https://raw.githubusercontent.com/Bletch1971/PixelmonInformation/master/8.0/updateforge.json";
