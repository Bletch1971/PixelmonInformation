...
public class PokemonBossCategory extends BlankRecipeCategory<PokemonBossWrapper> {
    ...
    public PokemonBossCategory() {
    	super(CATEGORY, 
    			PixelmonJei.getGuiHelper().createDrawable(TEXTURE_LOCOCATION_ICON, 48, 16, 16, 16),
	...
	@Override
	public void setRecipe(IRecipeLayout recipeLayout, PokemonBossWrapper recipeWrapper, IIngredients ingredients) {
