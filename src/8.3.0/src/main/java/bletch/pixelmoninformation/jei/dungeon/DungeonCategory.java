...
public class DungeonCategory extends BlankRecipeCategory<DungeonWrapper> {
	...
	public static final String CATEGORY = "dungeonchest";
    ...
    public DungeonCategory() {
    	super(CATEGORY, 
    			PixelmonJei.getGuiHelper().createDrawable(TEXTURE_LOCOCATION_ICON, 16, 0, 16, 16),
    ...
    @Override
    public void setRecipe(IRecipeLayout recipeLayout, DungeonWrapper recipeWrapper, IIngredients ingredients) {
