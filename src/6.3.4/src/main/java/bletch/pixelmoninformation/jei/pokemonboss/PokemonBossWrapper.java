...
public class PokemonBossWrapper implements IRecipeWrapper, ITooltipCallback<ItemStack> {
    ...
    public void updateButtonsState() {
    	double temp = (double)amountOfItems() / (double)PokemonBossCategory.ITEMS_PER_PAGE;
