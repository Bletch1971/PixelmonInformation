...
public class ModDetails {
	...
	private static final int VersionRevision = 4;
	...
	public static final String MOD_DEPENDENCIES = "required-after:minecraft@[1.12.2];required-after:forge@[14.23.5.2768,);required-after:pixelmon@[7.0.0,7.1.0);after:jei;after:waila;after:theoneprobe;after:jeresources";

	public static final String MOD_UPDATE_URL="https://raw.githubusercontent.com/Bletch1971/PixelmonInformation/master/7.0/updateforge.json";
